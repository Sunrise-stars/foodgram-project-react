...
from .views import (TagViewSet, IngredientViewSet, RecipeViewSet, FavoriteRecipeView, CartRecipeView, SubscriptionsView,
...
urlpatterns = [
    ...
    path('recipes/<int:id>/shopping_cart/', CartRecipeView.as_view(), name='shopping_cart'),
    path('users/<int:id>/subscribe/', SubscriptionsView.as_view(),name='subscribe'),
